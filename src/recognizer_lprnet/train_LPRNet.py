...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="./data/ccpd_after_incise/train_dataset",
                        help='the train images path')
    parser.add_argument('--test_img_dirs', default="./data/ccpd_after_incise/test_dataset", help='the test images path')
    parser.add_argument('--train_label_file', default="./data/ccpd_after_incise/train_dataset.txt",
                        help='the train label path')
    parser.add_argument('--test_label_file', default="./data/ccpd_after_incise/test_dataset.txt",
                        help='the test label path')
...
def train():
    ...
    train_dataset = LPRDataLoader(train_img_dirs.split(','), args.train_label_file, args.img_size, args.lpr_max_len)
    test_dataset = LPRDataLoader(test_img_dirs.split(','), args.test_label_file, args.img_size, args.lpr_max_len)
